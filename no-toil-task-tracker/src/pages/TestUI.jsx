...
export default function TestUI({style}) {
   return <div id="TestUI Page" style={{
      minHeight: "100vh",
      ...style
   }}>
      ...
      <div id="Content" style={{
         ...
         <MasonryLayout cardWidth={300} style={{padding: "1em"}}>
            ...
            <MasonryCard>
               <h2>3</h2>
               <h3>Ticket Name</h3>
               <p>Ticket description. Some extra content too. Just filling in the lines.</p>
               <p>Ticket description.</p>
               <p>Ticket description. Some extra content too. Just filling in the lines.</p>
               <p>Ticket description.</p>
            </MasonryCard>
...
export const Demo = () => {
   ...
   const [hoverable, hovered] = ReactUse.useHover(element)
