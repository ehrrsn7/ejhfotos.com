...
export default function Links() {
	...
	document.title = "Linktree | Elijah Harrison";

	return <div className='bg-hero flex flex-col justify-center items-center h-screen'>
		<div>
			<motion.h1
				initial = {{ y: 1000}}
				animate = {{ y: 0}}
		...
		<div>
			<motion.h1
				...
				transition = {{ type: "spring", duration: 0.5}}
			>
			<p className="px-6 pt-2 pb-2.5 font-large text-xl text-center text-black">@ejhfotos</p>
		...
		<div className='py-4 text-black'>
			...
			<h5 className="mb-2 text-2xl font-bold tracking-tight text-black-900 text-black">Welcome to my social page!👋</h5>
			<p className="font-bold text-black-700 selection:text-gray-400 text-xs">Check out my links below.</p>
			</a>
		</div>
		<div>
			<a href="http://ejhfotos.com/" rel="noopener noreferrer" target="_blank">
		...
		<div className='py-4  border-black'>
			<a href="https://github.com/ehrrsn7" rel="noopener noreferrer" target="_blank">
			<motion.button type="button" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="text-gray-900 border-black bg-white hover:bg-white/90 focus:ring-4 focus:outline-none focus:ring-white/50 font-medium rounded-lg text-lg w-96 px-6 pt-2.5 pb-2 flex justify-between">
		...
		<div>
			<a href="https://www.linkedin.com/in/ejhfotos" rel="noopener noreferrer" target="_blank" >
		...
		<footer>
			...
			<span className="text-sm text-gray-300 sm:text-center">Desgined & developed with ❤️ by <a className="text-blue-400" href="http://ejhfotos.com/" rel="noopener noreferrer" target="_blank">Elijah Harrison</a></span> 
			</div>
		</footer>
	</div>
}
