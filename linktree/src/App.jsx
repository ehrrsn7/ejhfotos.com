...
export default function App() {
      ...
      <Header />
      <div>
			{links.map(l => <a key={l.name} href={l.url}>
				<div>
					<button style={{margin: 0, padding: 0, paddingLeft: "1em", paddingRight: "1em", marginBottom: "1em"}}>
					<span style={{
						display: "flex",
						flexDirection: "row",
						placeItems: "center",
						...
						<img src={l.icon} alt="instagram logo" width="20px" style={{
							paddingRight: "1em", paddingTop: "-1em"
						}} />
